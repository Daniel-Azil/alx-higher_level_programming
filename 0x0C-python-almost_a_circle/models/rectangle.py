...
class Rectangle(Base):
    ...
    @property
    def y(self):
        """ Initialised getter for the attribute
            y with the decorator '@property'
        """
        return self.__y

    @y.setter
    def y(self, given_num):
        """Initialised setter for the attribute y with
           the decorator '@y.setter'
        """
        if type(given_num) is not int:
